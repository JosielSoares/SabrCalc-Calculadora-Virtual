...
O código está disponível no arquivo <strong>KvApp.py</strong> para a Classe Principal <br>
O código está também no arquivo <strong>KvGui.kv</strong> para a Interface Gráfica
